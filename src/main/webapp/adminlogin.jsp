    ...
    <div class="bg-white p-10 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="CustomerLoginController" method="post" class="space-y-4">
            <div>
                ...
                <input type="text" name="usernameTxt" class="w-full border border-gray-300 rounded px-4 py-2" placeholder="Mobile" required>
            </div>
            <div>
			...
			<p class="text-center"><a href="login.jsp" class="text-blue-600 hover:underline font-medium"> Customer Login </a></p>
